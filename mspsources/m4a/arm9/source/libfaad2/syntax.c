                                          ...
                                          uint8_t channel, uint8_t *tag)
{
    ...
    static ALIGN int16_t spec_data[1024] = {0};

//    memset(&sce, 0, sizeof(element));
//    memset(spec_data, 0, 1024*sizeof(int16_t));
...
{
    static ALIGN int16_t spec_data1[1024];
    static ALIGN int16_t spec_data2[1024];
    static element cpe;
    ic_stream *ics1 = &(cpe.ics1);
    ic_stream *ics2 = &(cpe.ics2);
    uint8_t result;

//    memset(spec_data1, 0, 1024*sizeof(int16_t));
//    memset(spec_data2, 0, 1024*sizeof(int16_t));

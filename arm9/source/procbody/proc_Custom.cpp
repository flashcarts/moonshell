...
enum ECompChecks {ECCS_SkipSetupChk,ECCS_BootCheckDiskChk,
                  ECCS_ClickSoundChk,ECCS_EnableFadeEffectChk,ECCS_AutoLastStateChk,
                  ECCS_MoveFolderLockedChk,ECCS_HiddenFilenameExtChk,ECCS_HiddenNotSupportFileTypeChk,
                  ECCS_ShowID3TagChk,ECCS_ScreenSaver_BlackModeChk,ECCS_DisableLRKeyOnPanelClosedChk,ECCS_LRClickLongSeekChk,
                  ECCSCount};
...
static void CompsInit(void)
{
  ...
  
  {
    ...
    pcc->pMsgUTF8=Lang_GetUTF8("CS_SkipSetup");
  ...
  
  {
    ...
    pcc->pMsgUTF8=Lang_GetUTF8("CS_BootCheckDisk");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;
  ...
  
  {
    ...
    pcc->pMsgUTF8=Lang_GetUTF8("CS_ClickSound");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;
  
  {
    TComponentCheck *pcc=&CompChecks[ECCS_EnableFadeEffectChk];
    pcc->UserData=(u32)&pcps->System.EnableFadeEffect;
    pcc->pMsgUTF8=Lang_GetUTF8("CS_EnableFadeEffect");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;
  
  {
    TComponentCheck *pcc=&CompChecks[ECCS_AutoLastStateChk];
    pcc->UserData=(u32)&pcps->System.AutoLastState;
    pcc->pMsgUTF8=Lang_GetUTF8("CS_AutoLastState");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;
  ...
  {
    TComponentCheck *pcc=&CompChecks[ECCS_MoveFolderLockedChk];
    pcc->UserData=(u32)&pcps->FileList.MoveFolderLocked;
    pcc->pMsgUTF8=Lang_GetUTF8("CS_MoveFolderLocked");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;
  
  {
    TComponentCheck *pcc=&CompChecks[ECCS_HiddenFilenameExtChk];
    pcc->UserData=(u32)&pcps->FileList.HiddenFilenameExt;
    pcc->pMsgUTF8=Lang_GetUTF8("CS_HiddenFilenameExt");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;
  
  {
    TComponentCheck *pcc=&CompChecks[ECCS_HiddenNotSupportFileTypeChk];
    pcc->UserData=(u32)&pcps->FileList.HiddenNotSupportFileType;
    pcc->pMsgUTF8=Lang_GetUTF8("CS_HiddenNotSupportFileType");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;
  
  {
    TComponentCheck *pcc=&CompChecks[ECCS_DisableLRKeyOnPanelClosedChk];
    pcc->UserData=(u32)&pcps->FileList.DisableLRKeyOnPanelClosed;
    pcc->pMsgUTF8=Lang_GetUTF8("CS_DisableLRKeyOnPanelClosed");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;
  
  {
    ...
    pcc->UserData=(u32)&pcps->FileList.LRClickLongSeek;
    pcc->pMsgUTF8=Lang_GetUTF8("CS_LRClickLongSeek");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;
  ...
  
  {
    ...
    pcc->UserData=(u32)&pcps->FileList.ShowID3Tag;
    pcc->pMsgUTF8=Lang_GetUTF8("CS_ShowID3Tag");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;
  
  {
    TComponentCheck *pcc=&CompChecks[ECCS_ScreenSaver_BlackModeChk];
    pcc->UserData=(u32)&pcps->FileList.ScreenSaver_BlackMode;
    pcc->pMsgUTF8=Lang_GetUTF8("CS_ScreenSaver_BlackMode");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;

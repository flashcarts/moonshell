...
enum ECompLabels {ECLS_TitleLbl,ECLS_TopScrModeTitleLbl,ECLS_LineSpaceTitleLbl,ECLS_FontSizeTitleLbl,ECLS_CPTitleLbl,ECLS_DetectCharCodeTitleLbl,ECLSCount};
#define CompLabelsCount (ECLSCount)
static TComponentLabel CompLabels[CompLabelsCount];

enum ECompChecks {ECCS_TopScrModeLightOffRadio,ECCS_TopScrModeTextRadio,ECCS_TopScrModeClockRadio,
                  ECCS_ScreenSaver_BlackModeChk,
                  ECCS_FontSizeSmallRadio,ECCS_FontSizeMiddleRadio,ECCS_FontSizeLargeRadio,
                  ECCS_ClearTypeFontChk,
                  ...
                  ECCS_DetectCharCode_ANSIChk,ECCS_DetectCharCode_SJISChk,ECCS_DetectCharCode_UTF16BEChk,ECCS_DetectCharCode_UTF16LEChk,ECCS_DetectCharCode_UTF8Chk,
                  ECCSCount};
...
static void Setting_Redraw(void)
{
  ...
  
  {
    ...
    switch(pCurrentProcState->Text.TopScrMode){
      case ETTSM_Text: CompChecks[ECCS_TopScrModeTextRadio].Checked=true; break;
...
static void CompsInit(void)
{
  ...
  
  {
    ...
    pcc->UserData=(u32)&pcps->Text.ScreenSaver_BlackMode;
    pcc->pMsgUTF8=Lang_GetUTF8("TCS_ScreenSaver_BlackMode");
  ...
  {
    TComponentCheck *pcc=&CompChecks[ECCS_ClearTypeFontChk];
    pcc->UserData=(u32)&pcps->Text.ClearTypeFont;
    pcc->pMsgUTF8=Lang_GetUTF8("TCS_ClearTypeFont");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;
  ...
  
  {
    u32 rx=x;
    {
      ...
      pcc->pMsgUTF8=Lang_GetUTF8("TCS_DetectCharCode_ANSI");
      pcc->Rect=CreateRect(rx,y,chkw,chkh);
      rx+=ComponentCheck_GetWidth(pcc);
    }
    
    {
      ...
      pcc->pMsgUTF8=Lang_GetUTF8("TCS_DetectCharCode_UTF8");
      pcc->Rect=CreateRect(rx,y,chkw,chkh);
    }
  }
  y+=TextHeight*2;
  ...
  {
    TComponentCheck *pcc=&CompChecks[ECCS_DetectCharCode_SJISChk];
    pcc->UserData=(u32)&pcps->Text.DetectCharCode_SJIS;
    pcc->pMsgUTF8=Lang_GetUTF8("TCS_DetectCharCode_SJIS");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;
  
  {
    ...
    pcc->pMsgUTF8=Lang_GetUTF8("TCS_DetectCharCode_UTF16BE");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;
  
  {
    ...
    pcc->pMsgUTF8=Lang_GetUTF8("TCS_DetectCharCode_UTF16LE");
    pcc->Rect=CreateRect(x,y,chkw,chkh);
  }
  y+=TextHeight*2;

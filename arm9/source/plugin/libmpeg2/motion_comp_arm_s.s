...
MC_put_o_16_arm_align_jt
	DCD MC_put_o_16_arm_align0
	DCD MC_put_o_16_arm_align1
	DCD MC_put_o_16_arm_align2
	DCD MC_put_o_16_arm_align3

; ----------------------------------------------------------------
	EXPORT MC_put_o_8_arm
MC_put_o_8_arm
	;; void func(uint8_t * dest, const uint8_t * ref, int stride, int height)
;	pld [r1]
...
MC_put_o_8_arm_align_jt
	DCD MC_put_o_8_arm_align0
	DCD MC_put_o_8_arm_align1
	DCD MC_put_o_8_arm_align2
	DCD MC_put_o_8_arm_align3

; ----------------------------------------------------------------
	MACRO
$lb	AVG_PW $rW1, $rW2
$lb	mov $rW2, $rW2, lsl #24
...
;	pld [r1]
	...
	MACRO
$lb	ADJ_ALIGN_QW $shift, $R0, $R1, $R2, $R3, $R4
$lb	mov $R0, $R0, lsr #($shift)
...
MC_put_x_16_arm_align_jt
	DCD 0x01010101
	DCD MC_put_x_16_arm_align0
	DCD MC_put_x_16_arm_align1
	DCD MC_put_x_16_arm_align2
	DCD MC_put_x_16_arm_align3

; ----------------------------------------------------------------
	EXPORT MC_put_x_8_arm
MC_put_x_8_arm
	;; void func(uint8_t * dest, const uint8_t * ref, int stride, int height)
;	pld [r1]
	stmfd sp!, {r4-r11,lr} ; R14 is also called LR
	...
	MACRO
$lb	ADJ_ALIGN_DW $shift, $R0, $R1, $R2
$lb	mov $R0, $R0, lsr #($shift)
	orr $R0, $R0, $R1, lsl #(32 - $shift)
	mov $R1, $R1, lsr #($shift)
	orr $R1, $R1, $R2, lsl #(32 - $shift)
...
MC_put_x_8_arm_align_jt
	DCD 0x01010101
	DCD MC_put_x_8_arm_align0
	DCD MC_put_x_8_arm_align1
	DCD MC_put_x_8_arm_align2
	DCD MC_put_x_8_arm_align3

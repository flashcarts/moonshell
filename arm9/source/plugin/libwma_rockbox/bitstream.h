                   ...
                   const uint8_t *buffer, int bit_size)
{
    ...
    if(buffer_size < 0 || bit_size < 0) {
        ...
        buffer = NULL;
        DEBUGF("BitStream: init_get_bits bit_size(%d) error.\n",bit_size);
        return;
    }
...
static inline int skip_bits_trace(GetBitContext *s, int n, char *file, const char *func, int line){
    int r= get_bits(s, n);

//    print_bin(r, n);
//    av_log(NULL, AV_LOG_DEBUG, "%5d %2d %3d bit @%5d in %s %s:%d\n", r, n, r, get_bits_count(s)-n, file, func, line);
    av_log(NULL, AV_LOG_DEBUG, "%5d %2d %3d bit @%5d in %s:%d\n", r, n, r, get_bits_count(s)-n, func, line);
}
...
//    av_log(NULL, AV_LOG_DEBUG, "%5d %2d %3d vlc @%5d in %s %s:%d\n", bits2, len, r, pos, file, func, line);
    av_log(NULL, AV_LOG_DEBUG, "%5d %2d %3d vlc @%5d in %s:%d\n", bits2, len, r, pos, func, line);
    return r;
}
...
//    av_log(NULL, AV_LOG_DEBUG, "%5d %2d %3d xbt @%5d in %s %s:%d\n", show, n, r, get_bits_count(s)-n, file, func, line);
    av_log(NULL, AV_LOG_DEBUG, "%5d %2d %3d xbt @%5d in %s:%d\n", show, n, r, get_bits_count(s)-n, func, line);
    return r;
}

#define skip_bits(s, n)  skip_bits_trace(s, n, __FILE__, __PRETTY_FUNCTION__, __LINE__)

...
#error unsupport
#else
    res+=((double)p[0])/0x10000;
    res+=((double)p[1])/0x100;
    res+=((double)p[2]);
    res+=((double)p[3])*0x100;
    res+=((double)p[4])*0x10000;
    res+=((double)p[5])*0x1000000;
    res+=((double)p[6])*0x1000000*0x100;
    res+=((double)p[7])*0x1000000*0x10000;
#endif
    return res;
}

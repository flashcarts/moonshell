...
enum GL_TEXTURE_PARAM_ENUM {
	...
	TEXGEN_OFF      = ((u32)0<<30), /*!< use unmodified texcoord */
	TEXGEN_TEXCOORD = ((u32)1<<30), /*!< multiply texcoords by the texture-matrix */
	TEXGEN_NORMAL   = ((u32)2<<30), /*!< set texcoords equal to normal * texture-matrix, used for spherical reflection mapping */
	TEXGEN_POSITION = ((u32)3<<30)  /*!< set texcoords equal to vertex * texture-matrix */
};
